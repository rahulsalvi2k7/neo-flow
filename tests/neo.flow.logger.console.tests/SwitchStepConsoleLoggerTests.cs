...
{
    [TestFixture]
    public class SwitchStepConsoleLoggerTests
    {
        ...
        {
            var logger = new SwitchStepConsoleLogger();
            var step = new SwitchStep("MySwitch", new System.Collections.Generic.List<(ICondition, IBusinessStep)>());
